...
import com.github.isabsent.exoview.orientation.SensorOrientation;
...
//    }
    ...
    public ExoVideoPlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr, AttributeSet playbackAttrs) {
        ...
        if (playbackAttrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(playbackAttrs, R.styleable.ExoVideoPlaybackControlView, 0, 0);
            try {
                rewindMs = a.getInt(R.styleable.ExoVideoPlaybackControlView_rewind_increment, rewindMs);
                fastForwardMs = a.getInt(R.styleable.ExoVideoPlaybackControlView_fastforward_increment, fastForwardMs);
                ...
                showShuffleButton = a.getBoolean(R.styleable.ExoVideoPlaybackControlView_show_shuffle_button, showShuffleButton);
        ...
        sensorOrientation = new SensorOrientation(getContext(), orientation -> {
    ...
    private synchronized void changeOrientation(int orientation) {
